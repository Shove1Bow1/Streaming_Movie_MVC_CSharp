...
{
    public partial class webnangcaoContext : DbContext
    {
        public webnangcaoContext()
        {
        }

        public webnangcaoContext(DbContextOptions<webnangcaoContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=DESKTOP-P6811AB;Database=FilmDatabase;Trusted_Connection=True;");
            }
        }
